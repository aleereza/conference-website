...
<p>Lecture presentations will be allocated in 20-minute time slots. In general, the authors should aim at using 17-18 minutes for their talk and should leave 2-3 minutes for questions. Laptop, LCD projector and laser pointer will be available in the room. In case anything else is required, please contact the General Chairs.
</p>
...
<p>Please read the following instructions carefully. By submitting a manuscript to MMSP, the authors guarantee that the material is original and that it has not been published, and is not currently submitted for consideration, elsewhere.</p><p>Two types of papers will be considered for submission: regular and special session papers (full paper) and demo papers. <strong>Only accepted regular and special session (full) papers will be published on IEEE Xplore. </strong>All accepted papers will be included in the digital conference proceedings.</p><p><strong>1. Regular and Special Session papers (Full Paper):</strong> 4-6 page paper, including all text, figures and references, ready for archival publication in IEEE Xplore if accepted.</p><p><strong>2. Demo Paper:</strong> 1 page paper with Title, Author/s, Abstract, and Prototype Description.</p><p>All paper types <strong>MUST</strong> be formatted according to Microsoft Word or Latex templates given below.</p><p>All papers <strong>MUST</strong> be submitted by their respective <Link className={styles.link} to="/dates">deadline dates</Link>. There will be no exceptions.</p>
<p>Accepted papers <strong>MUST</strong> be presented at the conference by one of the authors, or, if none of the authors are able to attend, by a qualified proxy, approved at least two weeks in advance of the conference dates by the TPC co-chairs. In case a paper is not presented at the workshop, it shall be deemed a “no-show.” For the poster session, in case there is no speaker in front of a poster, this implies a “no-show” (one of the authors should be present at the beginning and for most of entire poster session, for the introduction of the paper and answering questions). <strong>No-show papers will not appear on IEEE Xplore following the IEEE No-Show Policy. </strong>Exceptions to this policy will be made by the MMSP 2018 Technical Program Chairs only if there is evidence that the no-show occurred because of unanticipated events beyond the control of the authors, and that every option available to the authors to present the paper was exhausted.
</p>
...
<p>A <strong>full</strong> (non-student) registration <strong>MUST</strong> be made by one of the demo paper authors by August 20. Failure to register before this deadline will result in automatic withdrawal of your demo paper from the conference proceedings and program.
</p>
<h3>Templates</h3>
...
<p>Please use PDF eXpress PLUS for online submission of regular and special session camera-ready (full) papers at this link:&nbsp;<a href="http://www.pdf-express.org/plus/">IEEE PDF eXpress Plus site</a>. The submission deadline is set for August 7. Authors <strong>MUST</strong> ensure that their paper contains a correct IEEE copyright notice (see below) at the footnote on the first page and that the paper pdf is checked using PDF eXpress before submission.
</p>
<h4>Submission of demo papers</h4>
<p>Please go to <a href="https://cmt3.research.microsoft.com/MMSP2018" rel="noopener noreferrer">cmt3.research.microsoft.com/MMSP2018</a> to submit the demo paper online. The submission deadline is set for August 15. Authors <strong>MUST</strong> ensure that their paper&nbsp;contains a correct IEEE copyright notice (see below) at the footnote on the first page and that the paper pdf is checked using PDF eXpress before submission.
</p>
...
<div>
  ...
  <ul>
    ...
    <li>For papers in which all authors are employed by a Crown government (UK, Canada, and Australia), the copyright notice is: <strong>978-1-5090-3649-3/17/$31.00 ©2017 Crown</strong>
    </li>
    <li>For papers in which all authors are employed by the European Union, the copyright notice is: <strong>978-1-5090-3649-3/17/$31.00 ©2017 European Union</strong>
    </li>
    <li>For all other papers, the copyright notice is:<strong> 978-1-5090-3649-3/17/$31.00 ©2017 IEEE</strong>
    </li>
  </ul>
  <p>The first author will be contacted after the submission to sign eCopyright form.
  </p>
  <p>If necessary, contact Maria Martini at m.martini@kingston.ac.uk or Safak Dogan at s.dogan@lboro.ac.uk for the appropriate copyright notice.
  </p>
</div>
...
<h4><strong>Creating your PDF eXpress Account</strong></h4>
<p>Log in to the <a href="http://www.pdf-express.org/plus" target="_blank" rel="noopener noreferrer">IEEE PDF eXpress Plus site</a>. First-time users should do the following:
  ...
  <ol>
    ...
    <li>Enter the following: 39884XP for the Conference ID, your email address, a password</li>
